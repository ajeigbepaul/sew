...
function Cart() {
  ...
  return (
    <div className="w-full">
      <div className="w-full h-screen max-w-5xl mx-auto overflow-hidden flex items-start justify-between space-x-2 mt-5 ">
        <div className="flex items-start w-3/4 justify-between flex-col p-4 bg-white shadow-lg">
        ...
        <div className="w-1/4">
          <div className="bg-white flex flex-col p-4 border border-gray-100 shadow-md rounded-md">
            <h2 className="mb-5 font-semibold">Cart Summary</h2>
